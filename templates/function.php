...
function loginFromSocialCallBack($socialUser, $connect) {
    ...
    if ($result->num_rows == 0) {
        $result = mysqli_query($connect, "INSERT INTO `nguoidung` (`MaND`, `Ho`, `Ten`, `SDT`, `Email`, `TaiKhoan`, `MatKhau`, `MaQuyen`, `TrangThai`) VALUES (NULL, NULL, '" . $socialUser['name'] . "',NULL, '" . $socialUser['email'] . "', NULL, NULL, 3, 1);");
        if (!$result) {
